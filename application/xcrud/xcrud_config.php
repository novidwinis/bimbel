<?php /** Configuration file; f0ska xCRUD v.1.6.0; 12/2013 */
class Xcrud_config
{
    // default connection
    public static $dbname = 'bimbel'; // Your database name
    ...
    public static $db_time_zone = false; // database time zone, if you want use system default - leave empty or set in false.
    //public static $local_time_correction = 0; // not available and maybe will be deleted
    ...
    public static $before_construct = 'xcrud_restore_session';
    public static $after_render = 'xcrud_store_session';
